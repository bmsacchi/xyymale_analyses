...
SAMDIR=/ohta2/bianca.sacchi/xyy_male/data/STAR_hap1
echo "picard version"
...
java -jar $PICARD SortSam \
        ...
        O=/ohta2/bianca.sacchi/xyy_male/data/STAR_hap1/sort_$i.bam \
...
java -jar $PICARD AddOrReplaceReadGroups \
        I=/ohta2/bianca.sacchi/xyy_male/data/STAR_hap1/sort_$i.bam \
        O=/ohta2/bianca.sacchi/xyy_male/data/STAR_hap1/sortrg_$i.bam \
        VALIDATION_STRINGENCY=LENIENT \
        RGID=$i \
        RGLB=lib1$i \
        RGPL=illumina$i \
