...
OUTPATH=/ohta2/bianca.sacchi/xyy_male/data/bwamem2_hap2
PATH_TO_HAP2_REFERENCE=/ohta2/bianca.sacchi/xyy_male/data/bwamem2_hap2/H2NCmale.fa
...
bwa-mem2 mem -t 8 $PATH_TO_HAP2_REFERENCE $INPATH/$i\R1.fastq.gz $INPATH/$i\R2.fastq.gz > $OUTPATH/$i.sam
