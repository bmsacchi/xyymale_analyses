...
genome='../data/genome_hap2'
fasta='/ohta2/Rumex/Dovetail_xyy_pacbio-male/scaffolded_assembly/H2NCmale.fa'
now=$(date)
echo "$now"
echo "STAR version:"
STAR --version 
...
#only needed first time I run this.
...
--twopassMode Basic \
--twopass1readsN -1 \
--outFileNamePrefix /ohta2/bianca.sacchi/xyy_male/data/STAR_hap2/pass2_$i \
--runThreadN 16
